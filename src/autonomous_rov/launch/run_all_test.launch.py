...
def generate_launch_description():
    ...
    fcu_url_arg = DeclareLaunchArgument('fcu_url', default_value='udp://192.168.2.1:14550@')
    ...
    robot_grasping_node = Node(
        package='autonomous_rov',
        executable='RobotGrasper',
        name='RobotGrasper',
        output='screen'
    )
